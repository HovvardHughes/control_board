...
void textStateAll()
{
  ...
  webSocket.textAll(String(state) + "|" + taskController.getDisplayMessageType() + "|" + temperatureMeasurer.getInCelsius() + "|" + currentMeasurer.getVoltageString() + "|" + currentMeasurer.getCathodeCurrentsString());
}
